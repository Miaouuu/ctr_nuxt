<template>
  <section>
    <div class="specContainer">
          ...
          <client-only>
            ...
            >
              ...
              >
                ...
                <div class="pickee" v-if="pick.id">
                  <img
                    v-if="pick.id != -1"
                    :src="require(`../assets/img/circuits/${pick.src}.jpg`)"
                  />
                </div>
                <div class="mapName">
                  <h4>
      ...
      <div class="specCategoryName" v-if="bans.length != 0">
        <div class="topContainer" v-if="bans.length != 0">
          <p>Banned</p>
          <client-only>
            <carousel
              class="pickContainer spec"
            ...
            >
              ...
              >
                ...
                <div class="pickee" v-if="ban.id">
                  <img
                    v-if="ban.id != -1"
                    :src="require(`../assets/img/circuits/${ban.src}.jpg`)"
                  />
                </div>
                <div class="mapName">
                  <h4>
